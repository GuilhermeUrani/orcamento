...
public class CadastrarOrcamentoUI implements Funcionalidade{
	...
	public void executar() {
		...
		scanner.nextLine();
		System.out.println("Informe um item de orçamentos: ");
		...
		var orcamento = new Orcamento(descricaoOrcamento, mes, ano, valorTotal, itensOrcamento);
	...
	private ItemOrcamento converter(String item) {
		...
		return new ItemOrcamento(origem, codigo, descrição, valorUnitario, unidade, quantidade, valorTotalInformado);
